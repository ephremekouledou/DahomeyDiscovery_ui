        ...
        >
          ...
          >
            <Flex vertical gap={0}>
              ...
              >
                Explorez les meilleures attractions et activités près de chez
                vous
              </Typography.Text>
            </Flex>
          </Flex>
          ...
          <div className="container mx-auto px-4 py-8">
            <div
              className={`grid grid-cols-1 ${
                !attraction.free ? "lg:grid-cols-3" : "lg:grid-cols-1"
              } gap-8`}
            >
              {/* Contenu principal */}
              <div className={!attraction.free ? "lg:col-span-2" : ""}>
                ...
                <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm">
                  ...
                  <div className="flex flex-wrap items-center gap-6 text-gray-600 mb-6">
                    ...
                    {attraction.groupSize != 0 && (
                      <div className="flex items-center gap-2">
                        <Users className="w-5 h-5" />
                        <span>
                          A partir de {attraction.groupSize} personnes
                        </span>
                      </div>
                    )}
                  </div>
